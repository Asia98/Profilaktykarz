...
insert into users_checkup_history (user_id, checkup_id, medical_checkup, last_checkup_date, is_last_checkup_good) values
	(1, 1, 'Morfologia', '2022-01-23', 1)
	, (1, 2, 'Odczyn Biernackiego (OB)', '2022-01-30', 1)
	, (1, 3, 'Stężenie glukozy we krwi', '2022-03-27', 1)
	, (1, 4, 'Badanie ogólne moczu', null, null)
	, (1, 5, 'Pomiar ciśnienia tętniczego', '2022-04-09', 0)
	, (1, 7, 'Kontrola znamion i pieprzyków', null, null)
	, (1, 9, 'Ogólne badanie u lekarza internisty', '2022-03-05', 0)
	, (1, 11, 'Kontrola stomatologiczna', '2022-03-21', 0)
	, (1, 12, 'Lipidogram', '2022-03-24', 1)
	, (1, 16, 'USG jamy brzusznej', '2022-03-14', 0)
	, (1, 18, 'RTG klatki piersiowej', '2022-02-06', 1)
	, (1, 36, 'Badanie jąder', '2022-02-27', 0)
	, (1, 43, 'Kontrola wzroku u okulisty', null, null)
	, (1, 45, 'Badanie dna oka', '2022-02-25', 1);


-- Testing users_calendar view whether it will show only the newest checkup 
insert into users_checkup_history (user_id, checkup_id, medical_checkup, last_checkup_date, is_last_checkup_good) values
	(1, 1, 'Morfologia', '2055-07-13', 1);